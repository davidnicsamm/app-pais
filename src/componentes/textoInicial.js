...
const textoInicial = () => {
    ...
    return(
        <Box >
            ...
            <p>
                Deinde qui fit, ut ego nesciam, sciant omnes, quicumque Epicurei esse voluerunt? Pauca mutat vel plura sane; Paulum, cum regem Persem captum adduceret, eodem flumine invectio? Semper enim ita adsumit aliquid, ut ea, quae prima dederit, non deserat.
            </p>
        </Box>
